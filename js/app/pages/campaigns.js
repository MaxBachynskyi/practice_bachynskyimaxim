    ...
    template: `
        ...
        <div class="inside-content">
            ...
            <div class="wrapper">
                ...
                <popup ref="details" title="Details">
                    <div class="popup-inner">
                        <div v-if="details && details.items">
                            <div v-for="detail in details.items" :key="detail.id">
                                {{ detail }}
                            </div>
                        </div>
                        <div v-else>
                ...
                <div class="table" v-if="!loader && data.items && data.items.length">
                    <table>
                        <thead>
                            <tr>
                                <th class="id">#</th>
                ...
                <div class="empty" v-if="!loader && (!data.items || !data.items.length)">
                    No items
                </div>
            </div>
        </div>
